...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/default"),
        "git@github.com:ChristopherDavenport/default.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/default")),
